...
public class SDMServiceImplTest {
    ...
    public void testCreateFolder() throws IOException {
        ...
        try (MockedStatic<TokenHandler> tokenHandlerMockedStatic = Mockito.mockStatic(TokenHandler.class)) {
            ...
            String actualResponse = sdmServiceImpl.createFolder(parentId, jwtToken, repositoryId, sdmCredentials);
    ...
    public void testGetFolderIdByPath() throws IOException {
        ...
        try (MockedStatic<TokenHandler> tokenHandlerMockedStatic = Mockito.mockStatic(TokenHandler.class)) {
            ...
            String actualResponse = sdmServiceImpl.getFolderIdByPath(parentId, jwtToken, repositoryId, sdmCredentials);
    ...
    public void testCreateDocument() throws IOException {
        ...
        try (MockedStatic<TokenHandler> tokenHandlerMockedStatic = Mockito.mockStatic(TokenHandler.class)) {
            ...
            SDMServiceImpl sdmServiceImpl = new SDMServiceImpl();
            JSONObject actualResponse = sdmServiceImpl.createDocument(cmisDocument, jwtToken, sdmCredentials);
