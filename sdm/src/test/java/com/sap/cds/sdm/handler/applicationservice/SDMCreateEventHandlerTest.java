...
public class SDMCreateEventHandlerTest {
    @Mock
    private CdsCreateEventContext mockContext;
    @Mock
    private List<CdsData> mockData;
    @Mock
    private AuthenticationInfo mockAuthInfo;
    @Mock
    private JwtTokenAuthenticationInfo mockJwtTokenInfo;
    ...
    public void setUp() {
        ...
        handlerSpy = spy(new SDMCreateEventHandler(eventFactory, storageReader, persistenceService, sdmService));
    }
    ...
    public void testCreateVersioned() throws IOException {
        ...
        when(mockMessages.error("Upload not supported for versioned repositories")).thenReturn(mockMessage);
    ...
    public void testCreateNonVersionedSuccess() throws IOException {
        ...
        when(mockModel.findEntity("some.qualified.Name.attachments")).thenReturn(Optional.of(mockEntity));
        ...
        InputStream contentStream = new ByteArrayInputStream(simulatedContent.getBytes(StandardCharsets.UTF_8));
        attachment1.put("up__ID", "up__id");
        attachment1.put("fileName", "sample1.pdf");
    ...
    public void testCreateNonVersionedDuplicate() throws IOException {
        ...
        attachment4.put("ID", "id1");
        attachment4.put("content", null);
        attachments.add(attachment1);
        attachments.add(attachment2);
        ...
        String expectedWarnMessage = "The following files already exist and could be uploaded:\n" +
                "• sample1.pdf\n" +
                "The following files contain potential malware and could be uploaded:\n" +
                "• sample2.pdf\n" +
                "The following files could not be uploaded:\n" +
                "• sample3.pdf\n" +
                "Content of the following files is empty. Either they are corrupted or not uploaded properly:\n" +
                "• sample4.pdf\n";
    ...
    public void testProcessBeforeDuplicateFiles() throws IOException {
        ...
        handlerSpy.processBefore(mockContext, mockData);
        verify(mockMessages).error(contains("The following files already exist and cannot be uploaded:"));
    }
