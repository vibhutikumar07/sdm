...
public class DBQuery {
    public static String getAttachmentsForUP__ID(CdsEntity attachmentEntity, PersistenceService persistenceService, String up__ID){
        ...
        if (rows.size() != 0) {
            String folderId = rows.get(0).get("folderId").toString();
            return folderId;
        }
        return null;
    }
